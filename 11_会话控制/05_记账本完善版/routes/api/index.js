...
//修改数据
router.patch('/account/:_id', checkTokenMiddleware, (req, res) => {
  let { _id } = req.params
...
// 获取单挑数据
router.get('/account/:_id', checkTokenMiddleware, (req, res) => {
  let { _id } = req.params;
...
//删除指定内容
router.delete('/account/:_id', checkTokenMiddleware, (req, res) => {
